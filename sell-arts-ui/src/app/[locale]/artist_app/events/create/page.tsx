    ...
    <div className="container mx-auto ">
      <Card className="shadow-none border-0 p-0 m-0">
        <CardHeader className="p-0 pb-8">
          <CardTitle className="text-2xl font-bold">{t("create-new-event")}</CardTitle>
        </CardHeader>
        <CardContent className="p-0 pb-8">
          <form className="space-y-6" onSubmit={form.handleSubmit}>
            ...
            <div className="space-y-2">
              <Label htmlFor="maxRegistration">{t("max-registrations")}</Label>
              ...
              <small className="text-slate-500">{t("enter-0-for-unlimited-registrations")}</small>
              <ErrorMessage error={form.errors.maxRegistration} touched={form.touched.maxRegistration} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="maxRegistration">{t("common.date")}</Label>
